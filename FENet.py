...
class FENet(nn.Module):
    def __init__(self, scale, **kwargs):
        ...
        self.entry_1 = wn(nn.Conv2d(1, 64, 3, 1, 1))
        ...
        self.exit = wn(nn.Conv2d(64, 1, 3, 1, 1))
        self.add_mean = MeanShift((0.4488, 0.4371, 0.4040), sub=True)
...
class MeanShift(nn.Module):
    def __init__(self, mean_rgb, sub):
        ...
        # g = mean_rgb[1] * sign
        # b = mean_rgb[2] * sign
        self.shifter = nn.Conv2d(1, 1, 1, 1, 0)
